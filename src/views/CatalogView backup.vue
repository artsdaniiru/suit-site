...
import CustomSelect from "../components/CustomSelect.vue"; // Убедитесь, что путь правильный
...
export default defineComponent({
  ...
  setup() {
    const itemsPerPage = ref(8); // Устанавливаем начальное значение
    ...
    const updateItemsPerPage = (value) => {
      ...
      currentPage.value = 1; // Сбрасываем текущую страницу при изменении количества элементов
    };
